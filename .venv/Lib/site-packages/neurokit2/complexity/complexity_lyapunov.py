...
def complexity_lyapunov(
    ...
    * Eckmann, J. P., Kamphorst, S. O., Ruelle, D., & Ciliberto, S. (1986). Liapunov
    ...
    if method in ["rosenstein", "rosenstein1993"]:
        ...
        raise ValueError(
            "NeuroKit error: complexity_lyapunov(): 'method' should be one of  'rosenstein1993', 'makowski', 'eckmann1986'."
        )
...
def _complexity_lyapunov_rosenstein(signal, delay=1, dimension=2, separation=1, len_trajectory=20, show=False, **kwargs):
